...
This program is designed to be used alongside CED VR by UCLA Physics. Refer to https://github.com/cms-outreach/ispy-analyzers for information regarding how to create a '.ig' file using CMSSW.
...
```
"CED VR Companion.exe" path_to_ig_file [options]
```

CED VR Companion accepts 1 argument (the path to your '.ig' file) when being called from the command line. An interface will display allowing you to select your desired event.
### Options
